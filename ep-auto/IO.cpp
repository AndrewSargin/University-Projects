...
void OpenFile(struct autoshow *&pautoshow, struct autoshow *&pendautoshow, FILE *&in) {
    ...
    if((in=fopen("/home/vboxuser/Documents/ep-auto/autoshow.db", "r"))==NULL)
...
void SaveFile(struct autoshow *pautoshow) {
    ...
    if((savedoc=fopen("/home/vboxuser/Documents/ep-auto/autoshow.db", "w+"))==NULL)
    {
        system("clear");
...
void PrintDoc(struct refbook *&pmade, struct refbook *&pmodel, struct refbook *&pclass, struct autoshow *&pautoshow, FILE *in, FILE *&refbook) {
    ...
    if((refbook=fopen("/home/vboxuser/Documents/ep-auto/made.db", "r"))==NULL)
    {
    ...
    fclose(refbook);
    if((refbook=fopen("/home/vboxuser/Documents/ep-auto/model.db", "r"))==NULL)
    {
    ...
    if((refbook=fopen("/home/vboxuser/Documents/ep-auto/class.db", "r"))==NULL)
    {
...
void ExportToTxt(struct refbook *&pmade, struct refbook *&pmodel, struct refbook *&pclass, struct autoshow *&pautoshow, FILE *in, FILE *&refbook) {
    ...
    exportfile=fopen("/home/vboxuser/Documents/ep-auto/autoshow.txt", "w+");
...
void About() {
    ...
    char readmeline[500];
    FILE *readme;
    if((readme=fopen("/home/vboxuser/Documents/ep-auto/README.md", "r"))==NULL)
